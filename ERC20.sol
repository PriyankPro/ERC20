...
contract OwnerShip {
    ...
    function changeOwner(address _to) public {
        require(
            ...
            "Only owner of the contract can execute it"
        );
        newOwner = _to;
    }
...
contract MyERC20 is ERC20_STD, OwnerShip {
    ...
    constructor(address minter_) {
        _name = "HappyBirthday Token";
        _symbol = "HBT";
        _totalSupply = 44000000; //44 Million
        _minter = minter_;
    ...
    function transfer(address _to, uint256 _value)
        ...
        returns (bool success)
    {
        require(tokenBalances[msg.sender] >= _value, "Insufficient Toekns");
